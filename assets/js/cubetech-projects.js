		...
		frame.on('close',function(data) {
			...
			images.each(function(image) {
				...
				if ( emptyUploadImageExist == 0 ) {
					jQuery('#cubetech_projects_movie').parent('td').parent('tr').before('<tr><th><label for="cubetech_projects_image">Bild '+counter+'</label></th><td><div class="cubetech-projects-infosection"><input name="cubetech_projects_image-'+counter+'" type="hidden" class="cubetech-upload-image cubetech-upload-image-'+counter+'" value="'+image.attributes.id+'" /><img src="'+image.attributes.url+'" class="cubetech-preview-image cubetech-preview-image-'+counter+' cubetech_projects_image-'+counter+'" alt="" style="max-height: 100px;" /><br /><input name="cubetech_projects-inpdf-'+counter+'" type="checkbox" class="cubetech-upload-inpdf cubetech-upload-inpdf-'+counter+'" /> In PDF<br /><input name="cubetech_projects-infrontend-'+counter+'" type="checkbox" class="cubetech-upload-infrontend cubetech-upload-infrontend-'+counter+'" /> Nicht in Frontend anzeigen<br /><a href="#" class="cubetech-clear-image-button">Bild entfernen</a></div><div class="cubetech-projects-deletesection" style="display: none" ><p>Bild entfernt</p></div></td></tr>');
					counter++;
